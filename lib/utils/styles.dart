...
const darkBlue = Color.fromRGBO(61, 153, 238, 1);
const lightBlue = Color.fromRGBO(154, 207, 255, 1);
...
TextStyle bodytext18Ww600 = GoogleFonts.lato(
  fontWeight: FontWeight.w600,
  fontSize: 18,
  color: Colors.black,
);
...
Widget cancelButton(BuildContext context, void Function()? onPressed) {
